      ...
      faq_pmu: [
        ...
        },
        {
          ...
          body: `
            ...
            <p>Day 8-12: Your brows, lips, eyeliners may look as though the pigment has completely faded – do not panic – take a deep breath and trust the process as mentioned above regarding the "Milk Skin" phenomenon.</p>

            <p>Days 14-28: Your brows may still look a little patchy or uneven, but the pigment will start to “reappear” as the pigment settles and the healing continues. You may get your touch-up/perfecting procedure done no sooner than 4 weeks for Microblading / Ombre’ shading brows, 6 weeks for Powdered Ombre’/Combo/ Hairstrokes Brows, and 8 weeks for lips or eyeliners to complete the look.</p>
            ...
            <p>Lasting result: Typically the lengths clients can go between touch-up appointments are as follows Microblading: 6 months - 2 Years. Ombre /Combo Brows: 1-3 Years. Hairstrokes eyebrows, Lips Blushing, Eyeliners: 2-5 Years.</p>
          `
        }
      ],
      faq_lip: [
