<template>
  <div>
    <h2>Permanent Make-up (Eyebrows, Lips Blushing, Eyeliners)</h2>
    ...
    return {
      ...
      faq_lip: [
        ...
        },
        {
          ...
          body: ` <p>Apply the given ointment as often as possible for 1 week. Do not let your lips dry out completely, since this can cause scabbing and cracking of skin surface.</p>
          <p>For at least 5 days, please do not consume any hot drinks or food. The hotness can result in the pigment fading faster and your lips will peel.</p>
          <p>For 5 days, please prevent going into a sauna, pool, and taking hot showers/bath. You can get your lips wet (i.e. when washing your face/mouth) but please do not get any hot water near your lip area. In other words, do not soak your face underwater in a bathtub or allow the shower to spray directly in your face.</p>
          <p>No exercising for 24 hours after the procedure.</p>
          <p>No lip fillers for 4 weeks post procedure.</p>
          <p>Do not scrub, scratch, or pick at the tattoo site at any time during the healing process – this can cause you to lose color that may not be repairable.</p>
          <p>No facials or masks for 15 days, and avoid them in the lips area indefinitely.</p>
          <p>No Neosporin, Vaseline, or other petroleum products while your lips are healing.</p>
          <p>	No anti-acne products (i.e. Benzoyl Peroxide, Pro-active) or lightening creams (bleach creams) – this will cause rapid fading.</p>
          <p>No anti-aging products or facial products containing Alpha Hydroxyls (AHAs), Retin-A, Lactic or Glycolic Acids.</p>`
        },
        {
          title: "Does it hurt?",
